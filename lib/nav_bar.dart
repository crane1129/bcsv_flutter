  ...
  Widget build(BuildContext context) {
    return Drawer(
      ...
      ListTile(
        contentPadding: EdgeInsets.only(left: 30.0),
        leading:
            Icon(FontAwesomeIcons.youtube, color: kActiveIconColor, size: 20),
      ...
      ListTile(
        ...
        title:
            LocaleText('News', style: TextStyle(fontWeight: FontWeight.bold)),
      ),
      ListTile(
        contentPadding: EdgeInsets.only(left: 30.0),
        ...
        onTap: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (_) => ServingTurnPage()));
        },
      ),
      ListTile(
        contentPadding: EdgeInsets.only(left: 30.0),
        leading:
            Icon(FontAwesomeIcons.bullhorn, color: kActiveIconColor, size: 20),
      ...
      ListTile(
        contentPadding: EdgeInsets.only(left: 30.0),
        leading:
            Icon(FontAwesomeIcons.bookOpen, color: kActiveIconColor, size: 20),
        title: LocaleText('Sunday Bible Text'),
        onTap: () {
      ...
      ListTile(
        contentPadding: EdgeInsets.only(left: 30.0),
        leading: Icon(FontAwesomeIcons.pen, color: kActiveIconColor, size: 20),
        title: LocaleText('Sermon Review'),
        onTap: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (_) => SermonReviewScreen()));
        },
      ),
      const Divider(),
      ListTile(
        leading: Icon(FontAwesomeIcons.calendarDay, color: kActiveIconColor),
      ...
      ListTile(
        leading:
            Icon(FontAwesomeIcons.handHoldingHeart, color: kActiveIconColor),
